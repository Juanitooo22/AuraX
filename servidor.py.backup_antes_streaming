...
# Whisper cargado UNA SOLA VEZ al iniciar AuraX
from faster_whisper import WhisperModel
print("🎤 Cargando Whisper small en GPU...")
...
def stt():
    ...
    try:
        ...
        # Whisper YA está cargado en memoria.
        # No se vuelve a inicializar en cada llamada.
