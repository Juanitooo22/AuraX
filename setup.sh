...
cd /workspace
if [ ! -d "$AURAX_DIR" ]; then
    git clone https://github.com/Juanitooo22/AuraX.git
else
    cd $AURAX_DIR && git pull
fi
cat > $AURAX_DIR/.env << 'ENVEOF'
SERPER_API_KEY=573f5e3abb5bab592e671afd580f1fbed3b81b87
DISCORD_TOKEN=MTUzMzcwNTI0NzgyNTA3MjEzOA.GPnG93.8viBP40Xs5qrt6XXhVKT7CRlq5UZzSobhiZXZA
DISCORD_OWNER_ID=1086360701632794666
GITHUB_TOKEN=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
